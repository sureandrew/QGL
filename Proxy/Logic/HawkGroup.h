...
private:
	...
	typedef StlMap<UInt32, UInt16Vector, std::less<UInt32>, ManagedAllocator<std::pair<UInt32, UInt16Vector> > > PPSkillMap;
	HawkItemMap m_itemList;
	HawkItemMap m_partnerList;
	HawkItemMap m_petList;
	PPSkillMap m_partnerSkillList;
	PPSkillMap m_petSkillList;
