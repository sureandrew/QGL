...
///////////////////////////////////////////////////////////
#pragma once
#ifndef _RPC_QUESTLOGDATA_PROXY_H_
#define _RPC_QUESTLOGDATA_PROXY_H_
...
class QuestLogData_Proxy : public NetObject
{
...
public:
	INLINE QuestLogData_Proxy()
			{ _fields _m = {}; m = _m; }

};

INLINE RPCResult QuestLogData_Proxy::SendRequest(LPCPEER pPeer, RPCContext &context, const RPCMask &mask)
{
	if (pPeer == NULL) return RPC_RESULT_FAIL;
	Buffer* pBuf = SafeCreateObject(Buffer);
	Reuben::Network::RPCHeader header(RPC_QuestLogData_REQ_STATE);
	pBuf->Write<Reuben::Network::RPCHeader>(header);
	pBuf->Write<RPCContext>(context);
	pBuf->Write<RPCNetID>(m_netId);
	pBuf->Write<RPCMask>(mask);

	return RPCSend<418150674>(pPeer, pBuf);
}


#ifdef _REUBEN_MATH_AES_H_
AES_DECRYPT_HEAD(1894523640)
	AES_IMIX_COLUMNS
	AES_ISHIFT_ROWS
	AES_ISUB_BYTES
	AES_IADD_ROUNDKEY
...
#endif //_RPC_QUESTLOGDATA_PROXY_H_
