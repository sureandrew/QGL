...
///////////////////////////////////////////////////////////
#pragma once
#ifndef _RPC_SELLYUANBAODATA_PROXY_H_
#define _RPC_SELLYUANBAODATA_PROXY_H_

#include "Common/RPCFunc.h"
#include "RPCEnum/SellYuanBaoData_enum.h"

class SellYuanBaoData_Proxy : public NetObject
{
...
public:
	INLINE SellYuanBaoData_Proxy()
			{ _fields _m = {}; m = _m; }

};

INLINE RPCResult SellYuanBaoData_Proxy::SendRequest(LPCPEER pPeer, RPCContext &context, const RPCMask &mask)
{
	if (pPeer == NULL) return RPC_RESULT_FAIL;
	Buffer* pBuf = SafeCreateObject(Buffer);
	Reuben::Network::RPCHeader header(RPC_SellYuanBaoData_REQ_STATE);
	pBuf->Write<Reuben::Network::RPCHeader>(header);
	pBuf->Write<RPCContext>(context);
	pBuf->Write<RPCNetID>(m_netId);
	pBuf->Write<RPCMask>(mask);

	return RPCSend<588066567>(pPeer, pBuf);
}


#ifdef _REUBEN_MATH_AES_H_
AES_DECRYPT_HEAD(515912530)
	AES_ISUB_BYTES
	AES_IADD_ROUNDKEY
	AES_IMIX_COLUMNS
	AES_ISHIFT_ROWS
...
#endif //_RPC_SELLYUANBAODATA_PROXY_H_
