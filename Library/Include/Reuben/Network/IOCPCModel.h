#pragma once
#ifndef _REUBEN_NETWORK_IOCPC_MODEL_H_
#define _REUBEN_NETWORK_IOCPC_MODEL_H_

#include "Interface.h"

namespace Reuben { namespace Network {

	//-- IOCP Max Connection Network Model
	...
	public:
		...
		IOCPCModel(PCSTRING pName, Reuben::Utility::ConfigFile& config = REUBEN_CONFIG, Reuben::Diagnostics::Logger& logger = REUBEN_LOGGER);
		~IOCPCModel(VOID);
		...
		CONST Boolean Send(CONST Peer* pPeer, Buffer* pBuffer, Boolean bLock = BOOLEAN_TRUE);
...
#endif // _REUBEN_NETWORK_IOCPC_MODEL_H_
