#pragma once
#ifndef _REUBEN_NETWORK_IOCPT_MODEL_H_
#define _REUBEN_NETWORK_IOCPT_MODEL_H_

#include "Interface.h"

namespace Reuben { namespace Network {

	//-- IOCP Throughput Network Model
	// @deprecated  Throws exception during runtime, use IOCPCModel instead
	...
	public:
		...
		IOCPTModel(PCSTRING pName, Reuben::Utility::ConfigFile& config = REUBEN_CONFIG, Reuben::Diagnostics::Logger& logger = REUBEN_LOGGER);
		~IOCPTModel(VOID);
...
#endif // _REUBEN_NETWORK_IOCPT_MODEL_H_
