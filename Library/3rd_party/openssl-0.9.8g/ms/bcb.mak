...
INSTALLTOP=E:\Program Files\VCLibary\openssl-0.9.8g\perl

# Set your compiler options
PLATFORM=BC-NT
CC=bcc32
CFLAG=-DWIN32_LEAN_AND_MEAN -q -w-ccc -w-rch -w-pia -w-aus -w-par -w-inl  -c -tWC -tWM -DOPENSSL_SYSNAME_WIN32 -DL_ENDIAN -DDSO_WIN32 -D_stricmp=stricmp -D_strnicmp=strnicmp -O2 -ff -fp -DBN_ASM -DMD5_ASM -DSHA1_ASM -DRMD160_ASM -DOPENSSL_NO_CAMELLIA -DOPENSSL_NO_SEED -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_TLSEXT -DOPENSSL_NO_KRB5 -DOPENSSL_NO_DYNAMIC_ENGINE    
APP_CFLAG=
LIB_CFLAG=
SHLIB_CFLAG=
...
CRYPTOOBJ=$(OBJ_D)\cryptlib.obj \
	...
	$(OBJ_D)\rand_key.obj $(DES_ENC_OBJ) $(OBJ_D)\fcrypt.obj \
	...
	$(OBJ_D)\rc4_skey.obj $(RC4_ENC_OBJ) $(OBJ_D)\i_cbc.obj \
	...
	$(OBJ_D)\aes_ctr.obj $(OBJ_D)\aes_ige.obj $(OBJ_D)\aes_core.obj \
...
$(OBJ_D)\md2test.obj: $(SRC_D)\crypto\md2\md2test.c
	$(CC) -o$(OBJ_D)\md2test.obj $(APP_CFLAGS) -c $(SRC_D)\crypto\md2\md2test.c
...
crypto\des\asm\d_win32.obj: crypto\des\asm\d_win32.asm
	$(ASM) -ocrypto\des\asm\d_win32.obj $(SRC_D)\crypto\des\asm\d_win32.asm

crypto\des\asm\y_win32.obj: crypto\des\asm\y_win32.asm
	$(ASM) -ocrypto\des\asm\y_win32.obj $(SRC_D)\crypto\des\asm\y_win32.asm

crypto\bf\asm\b_win32.obj: crypto\bf\asm\b_win32.asm
	$(ASM) -ocrypto\bf\asm\b_win32.obj $(SRC_D)\crypto\bf\asm\b_win32.asm

crypto\cast\asm\c_win32.obj: crypto\cast\asm\c_win32.asm
	$(ASM) -ocrypto\cast\asm\c_win32.obj $(SRC_D)\crypto\cast\asm\c_win32.asm

crypto\rc4\asm\r4_win32.obj: crypto\rc4\asm\r4_win32.asm
	$(ASM) -ocrypto\rc4\asm\r4_win32.obj $(SRC_D)\crypto\rc4\asm\r4_win32.asm

crypto\rc5\asm\r5_win32.obj: crypto\rc5\asm\r5_win32.asm
	$(ASM) -ocrypto\rc5\asm\r5_win32.obj $(SRC_D)\crypto\rc5\asm\r5_win32.asm

crypto\md5\asm\m5_win32.obj: crypto\md5\asm\m5_win32.asm
	$(ASM) -ocrypto\md5\asm\m5_win32.obj $(SRC_D)\crypto\md5\asm\m5_win32.asm

crypto\sha\asm\s1_win32.obj: crypto\sha\asm\s1_win32.asm
	$(ASM) -ocrypto\sha\asm\s1_win32.obj $(SRC_D)\crypto\sha\asm\s1_win32.asm

crypto\ripemd\asm\rm_win32.obj: crypto\ripemd\asm\rm_win32.asm
	$(ASM) -ocrypto\ripemd\asm\rm_win32.obj $(SRC_D)\crypto\ripemd\asm\rm_win32.asm
...
$(OBJ_D)\tmdiff.obj: $(SRC_D)\crypto\tmdiff.c
	$(CC) -o$(OBJ_D)\tmdiff.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\tmdiff.c
...
$(OBJ_D)\md2_dgst.obj: $(SRC_D)\crypto\md2\md2_dgst.c
	$(CC) -o$(OBJ_D)\md2_dgst.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\md2\md2_dgst.c

$(OBJ_D)\md2_one.obj: $(SRC_D)\crypto\md2\md2_one.c
	$(CC) -o$(OBJ_D)\md2_one.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\md2\md2_one.c
...
$(OBJ_D)\des_enc.obj: $(SRC_D)\crypto\des\des_enc.c
	$(CC) -o$(OBJ_D)\des_enc.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\des\des_enc.c

$(OBJ_D)\fcrypt_b.obj: $(SRC_D)\crypto\des\fcrypt_b.c
	$(CC) -o$(OBJ_D)\fcrypt_b.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\des\fcrypt_b.c
...
$(OBJ_D)\bf_enc.obj: $(SRC_D)\crypto\bf\bf_enc.c
	$(CC) -o$(OBJ_D)\bf_enc.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\bf\bf_enc.c
...
$(OBJ_D)\m_md2.obj: $(SRC_D)\crypto\evp\m_md2.c
	$(CC) -o$(OBJ_D)\m_md2.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\evp\m_md2.c
...
$(OBJ_D)\a_hdr.obj: $(SRC_D)\crypto\asn1\a_hdr.c
	$(CC) -o$(OBJ_D)\a_hdr.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\asn1\a_hdr.c
...
$(OBJ_D)\a_meth.obj: $(SRC_D)\crypto\asn1\a_meth.c
	$(CC) -o$(OBJ_D)\a_meth.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\asn1\a_meth.c
...
$(OBJ_D)\eng_padlock.obj: $(SRC_D)\crypto\engine\eng_padlock.c
	$(CC) -o$(OBJ_D)\eng_padlock.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\engine\eng_padlock.c
...
$(OBJ_D)\str_err.obj: $(SRC_D)\crypto\store\str_err.c
	$(CC) -o$(OBJ_D)\str_err.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\store\str_err.c

$(OBJ_D)\str_lib.obj: $(SRC_D)\crypto\store\str_lib.c
	$(CC) -o$(OBJ_D)\str_lib.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\store\str_lib.c

$(OBJ_D)\str_meth.obj: $(SRC_D)\crypto\store\str_meth.c
	$(CC) -o$(OBJ_D)\str_meth.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\store\str_meth.c

$(OBJ_D)\str_mem.obj: $(SRC_D)\crypto\store\str_mem.c
	$(CC) -o$(OBJ_D)\str_mem.obj  $(LIB_CFLAGS) -c $(SRC_D)\crypto\store\str_mem.c
...
$(TEST_D)\md2test.exe: $(OBJ_D)\md2test.obj $(LIBS_DEP)
	$(LINK) $(LFLAGS) $(OBJ_D)\md2test.obj $(APP_EX_OBJ), $(TEST_D)\md2test.exe,, $(L_LIBS) $(EX_LIBS)
