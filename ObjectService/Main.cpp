...
int _tmain(int argc, TCHAR* argv[])
{
	...
	if (argc > 5 && gConfigure.Initialize(argv[1], argv[2], argv[3], argv[4], argv[5]) || 
		argc <= 5 && gConfigure.Initialize(argv[1], argv[2]))
	{
		...
		ObjectApplication::GetInstance().Run();
		ObjectApplication::DestroyInstance();
