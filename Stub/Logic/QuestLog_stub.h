...
///////////////////////////////////////////////////////////
#pragma once
#ifndef _RPC_QUESTLOG_STUB_H_
#define _RPC_QUESTLOG_STUB_H_
...
class QuestLog_Stub : public NetObject
{
...
public:
	...
	void SetTarget1_name(const String &target1_name);
	void SetTarget2_name(const String &target2_name);
	void SetTarget3_name(const String &target3_name);
	void SetTarget4_name(const String &target4_name);
	void SetTarget5_name(const String &target5_name);
	void SetUpdateIcon(const Boolean &updateIcon);
...
public:
	INLINE QuestLog_Stub()
	{ _fields _m = {}; m = _m; }

};

#endif //_RPC_QUESTLOG_STUB_H_
