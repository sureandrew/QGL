...
///////////////////////////////////////////////////////////
#pragma once
#ifndef _RPC_MSGCHARACTERDATA_STUB_H_
#define _RPC_MSGCHARACTERDATA_STUB_H_

#include "Common/RPCFunc.h"
#include "RPCEnum/MsgCharacterData_enum.h"

class MsgCharacterData_Stub : public NetObject
{
...
public:
	...
	void Clone(MsgCharacterData_Stub* obj, const RPCMask &mask);
	friend void MsgCharacterData_Stub::Clone(MsgCharacterData_Stub* obj, const RPCMask &mask);
...
public:
	INLINE MsgCharacterData_Stub()
	{ _fields _m = {}; m = _m; }

};

#endif //_RPC_MSGCHARACTERDATA_STUB_H_
