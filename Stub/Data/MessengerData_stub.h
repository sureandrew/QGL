...
///////////////////////////////////////////////////////////
#pragma once
#ifndef _RPC_MESSENGERDATA_STUB_H_
#define _RPC_MESSENGERDATA_STUB_H_

#include "Common/RPCFunc.h"
#include "RPCEnum/MessengerData_enum.h"

class MessengerData_Stub : public NetObject
{
...
public:
	...
	void Clone(MessengerData_Stub* obj, const RPCMask &mask);
	friend void MessengerData_Stub::Clone(MessengerData_Stub* obj, const RPCMask &mask);
...
public:
	INLINE MessengerData_Stub()
	{ _fields _m = {}; m = _m; }

};

#endif //_RPC_MESSENGERDATA_STUB_H_
