...
void PartnerData_Stub::SetId(const UInt32 &partner_id, const UInt32 &mob_id)
{
	bool modified = false;
...
void PartnerData_Stub::SetPartner_id(const UInt32 &partner_id)
{
	bool modified = false;
	if (m.partner_id != partner_id) { m.partner_id = partner_id; modified = true; }
	MarkUpdateAll(idMask, modified);
...
void PartnerData_Stub::SetMob_id(const UInt32 &mob_id)
{
	bool modified = false;
	if (m.mob_id != mob_id) { m.mob_id = mob_id; modified = true; }
	MarkUpdateAll(idMask, modified);
...
void PartnerData_Stub::SetOwner(const UInt32 &owner_id)
{
	bool modified = false;
...
void PartnerData_Stub::SetOwner_id(const UInt32 &owner_id)
{
	bool modified = false;
	if (m.owner_id != owner_id) { m.owner_id = owner_id; modified = true; }
	MarkUpdateAll(ownerMask, modified);
...
void PartnerData_Stub::SetInfo(const String &raname)
{
	bool modified = false;
...
void PartnerData_Stub::SetRaname(const String &raname)
{
	bool modified = false;
	if (m.raname != raname) { m.raname = raname; modified = true; }
	MarkUpdateAll(infoMask, modified);
...
void PartnerData_Stub::SetLevel(const UInt16 &level)
{
	bool modified = false;
...
void PartnerData_Stub::SetExp(const UInt32 &exp)
{
	bool modified = false;
...
void PartnerData_Stub::SetAttrib1(const UInt16 &STA, const UInt16 &SPR, const UInt16 &STR, const UInt16 &CON, const UInt16 &AGI)
{
	bool modified = false;
...
void PartnerData_Stub::SetSTA(const UInt16 &STA)
{
	bool modified = false;
	if (m.STA != STA) { m.STA = STA; modified = true; }
	MarkUpdateAll(attrib1Mask, modified);
...
void PartnerData_Stub::SetSPR(const UInt16 &SPR)
{
	bool modified = false;
	if (m.SPR != SPR) { m.SPR = SPR; modified = true; }
	MarkUpdateAll(attrib1Mask, modified);
...
void PartnerData_Stub::SetSTR(const UInt16 &STR)
{
	bool modified = false;
	if (m.STR != STR) { m.STR = STR; modified = true; }
	MarkUpdateAll(attrib1Mask, modified);
...
void PartnerData_Stub::SetCON(const UInt16 &CON)
{
	bool modified = false;
	if (m.CON != CON) { m.CON = CON; modified = true; }
	MarkUpdateAll(attrib1Mask, modified);
...
void PartnerData_Stub::SetAGI(const UInt16 &AGI)
{
	bool modified = false;
	if (m.AGI != AGI) { m.AGI = AGI; modified = true; }
	MarkUpdateAll(attrib1Mask, modified);
...
void PartnerData_Stub::SetAttrPoint(const UInt16 &attrPoint)
{
	bool modified = false;
...
void PartnerData_Stub::SetNative(const UInt16 &HP_native, const UInt16 &SP_native, const UInt16 &ATK_native, const UInt16 &DEF_native, const UInt16 &SPD_native, const UInt16 &POW_native, const UInt16 &HIT_native, const UInt16 &EVA_native)
{
	bool modified = false;
...
void PartnerData_Stub::SetHP_native(const UInt16 &HP_native)
{
	bool modified = false;
	if (m.HP_native != HP_native) { m.HP_native = HP_native; modified = true; }
	MarkUpdateAll(nativeMask, modified);
...
void PartnerData_Stub::SetSP_native(const UInt16 &SP_native)
{
	bool modified = false;
	if (m.SP_native != SP_native) { m.SP_native = SP_native; modified = true; }
	MarkUpdateAll(nativeMask, modified);
...
void PartnerData_Stub::SetATK_native(const UInt16 &ATK_native)
{
	bool modified = false;
	if (m.ATK_native != ATK_native) { m.ATK_native = ATK_native; modified = true; }
	MarkUpdateAll(nativeMask, modified);
...
void PartnerData_Stub::SetDEF_native(const UInt16 &DEF_native)
{
	bool modified = false;
	if (m.DEF_native != DEF_native) { m.DEF_native = DEF_native; modified = true; }
	MarkUpdateAll(nativeMask, modified);
...
void PartnerData_Stub::SetSPD_native(const UInt16 &SPD_native)
{
	bool modified = false;
	if (m.SPD_native != SPD_native) { m.SPD_native = SPD_native; modified = true; }
	MarkUpdateAll(nativeMask, modified);
...
void PartnerData_Stub::SetPOW_native(const UInt16 &POW_native)
{
	bool modified = false;
	if (m.POW_native != POW_native) { m.POW_native = POW_native; modified = true; }
	MarkUpdateAll(nativeMask, modified);
...
void PartnerData_Stub::SetHIT_native(const UInt16 &HIT_native)
{
	bool modified = false;
	if (m.HIT_native != HIT_native) { m.HIT_native = HIT_native; modified = true; }
	MarkUpdateAll(nativeMask, modified);
...
void PartnerData_Stub::SetEVA_native(const UInt16 &EVA_native)
{
	bool modified = false;
	if (m.EVA_native != EVA_native) { m.EVA_native = EVA_native; modified = true; }
	MarkUpdateAll(nativeMask, modified);
...
void PartnerData_Stub::SetGrow(const float &grow)
{
	bool modified = false;
...
void PartnerData_Stub::SetHP(const UInt16 &HP, const UInt16 &maxHP)
{
	bool modified = false;
...
void PartnerData_Stub::SetHP(const UInt16 &HP)
{
	bool modified = false;
	if (m.HP != HP) { m.HP = HP; modified = true; }
	MarkUpdateAll(HPMask, modified);
...
void PartnerData_Stub::SetMaxHP(const UInt16 &maxHP)
{
	bool modified = false;
	if (m.maxHP != maxHP) { m.maxHP = maxHP; modified = true; }
	MarkUpdateAll(HPMask, modified);
...
void PartnerData_Stub::SetSP(const UInt16 &SP, const UInt16 &maxSP)
{
	bool modified = false;
...
void PartnerData_Stub::SetSP(const UInt16 &SP)
{
	bool modified = false;
	if (m.SP != SP) { m.SP = SP; modified = true; }
	MarkUpdateAll(SPMask, modified);
...
void PartnerData_Stub::SetMaxSP(const UInt16 &maxSP)
{
	bool modified = false;
	if (m.maxSP != maxSP) { m.maxSP = maxSP; modified = true; }
	MarkUpdateAll(SPMask, modified);
...
void PartnerData_Stub::SetFavor(const float &favor)
{
	bool modified = false;
...
void PartnerData_Stub::SetState(const UInt8 &state)
{
	bool modified = false;
...
void PartnerData_Stub::SetBuff(const String &buff)
{
	bool modified = false;
...
void PartnerData_Stub::SetHealth(const UInt16 &health)
{
	bool modified = false;
...
void PartnerData_Stub::SetGoodness(const Int32 &goodness)
{
	bool modified = false;
...
void PartnerData_Stub::SetSoulboundState(const UInt8 &soulboundState)
{
	bool modified = false;
...
void PartnerData_Stub::SetExpireDate(const UInt32 &expireDate)
{
	bool modified = false;
...
void PartnerData_Stub::SetElement(const UInt8 &element)
{
	bool modified = false;
...
void PartnerData_Stub::SetOutLookColor(const UInt16 &outLookColor)
{
	bool modified = false;
...
void PartnerData_Stub::SetInWareHouse(const UInt8 &inWareHouse)
{
	bool modified = false;
...
void PartnerData_Stub::SetAssetLock(const Boolean &lock)
{
	bool modified = false;
...
void PartnerData_Stub::SetLock(const Boolean &lock)
{
	bool modified = false;
	if (m.lock != lock) { m.lock = lock; modified = true; }
	MarkUpdateAll(assetLockMask, modified);
...
void PartnerData_Stub::SetCultivation(const UInt16 &cultivation)
{
	bool modified = false;
...
void PartnerData_Stub::SetPractice(const UInt16 &practice)
{
	bool modified = false;
...
void PartnerData_Stub::Clone(PartnerData_Stub* obj, const RPCMask &mask)
{
	if (obj == NULL) return;

	Parent::Clone(obj, mask);
	if (mask.IsBit(idMask) && !(obj->m.partner_id == m.partner_id)) {
		m.partner_id = obj->m.partner_id;
		MarkUpdateAll(idMask, true);
	}
	if (mask.IsBit(idMask) && !(obj->m.mob_id == m.mob_id)) {
		m.mob_id = obj->m.mob_id;
		MarkUpdateAll(idMask, true);
	}
	...
	if (mask.IsBit(infoMask) && !(obj->m.raname == m.raname)) {
		m.raname = obj->m.raname;
	...
	if (mask.IsBit(attrib1Mask) && !(obj->m.STA == m.STA)) {
		m.STA = obj->m.STA;
		MarkUpdateAll(attrib1Mask, true);
	}
	if (mask.IsBit(attrib1Mask) && !(obj->m.SPR == m.SPR)) {
		m.SPR = obj->m.SPR;
		MarkUpdateAll(attrib1Mask, true);
	}
	if (mask.IsBit(attrib1Mask) && !(obj->m.STR == m.STR)) {
		m.STR = obj->m.STR;
		MarkUpdateAll(attrib1Mask, true);
	}
	if (mask.IsBit(attrib1Mask) && !(obj->m.CON == m.CON)) {
		m.CON = obj->m.CON;
		MarkUpdateAll(attrib1Mask, true);
	}
	if (mask.IsBit(attrib1Mask) && !(obj->m.AGI == m.AGI)) {
		m.AGI = obj->m.AGI;
		MarkUpdateAll(attrib1Mask, true);
	}
	...
	if (mask.IsBit(nativeMask) && !(obj->m.HP_native == m.HP_native)) {
		m.HP_native = obj->m.HP_native;
		MarkUpdateAll(nativeMask, true);
	}
	if (mask.IsBit(nativeMask) && !(obj->m.SP_native == m.SP_native)) {
		m.SP_native = obj->m.SP_native;
		MarkUpdateAll(nativeMask, true);
	}
	if (mask.IsBit(nativeMask) && !(obj->m.ATK_native == m.ATK_native)) {
		m.ATK_native = obj->m.ATK_native;
		MarkUpdateAll(nativeMask, true);
	}
	if (mask.IsBit(nativeMask) && !(obj->m.DEF_native == m.DEF_native)) {
		m.DEF_native = obj->m.DEF_native;
		MarkUpdateAll(nativeMask, true);
	}
	if (mask.IsBit(nativeMask) && !(obj->m.SPD_native == m.SPD_native)) {
		m.SPD_native = obj->m.SPD_native;
		MarkUpdateAll(nativeMask, true);
	}
	if (mask.IsBit(nativeMask) && !(obj->m.POW_native == m.POW_native)) {
		m.POW_native = obj->m.POW_native;
		MarkUpdateAll(nativeMask, true);
	}
	if (mask.IsBit(nativeMask) && !(obj->m.HIT_native == m.HIT_native)) {
		m.HIT_native = obj->m.HIT_native;
		MarkUpdateAll(nativeMask, true);
	}
	if (mask.IsBit(nativeMask) && !(obj->m.EVA_native == m.EVA_native)) {
		m.EVA_native = obj->m.EVA_native;
		MarkUpdateAll(nativeMask, true);
	}
	if (mask.IsBit(growMask) && !(obj->m.grow == m.grow)) {
		m.grow = obj->m.grow;
		MarkUpdateAll(growMask, true);
	}
	...
	if (mask.IsBit(favorMask) && !(obj->m.favor == m.favor)) {
		m.favor = obj->m.favor;
		MarkUpdateAll(favorMask, true);
	}
	...
	if (mask.IsBit(healthMask) && !(obj->m.health == m.health)) {
		m.health = obj->m.health;
		MarkUpdateAll(healthMask, true);
	}
	if (mask.IsBit(goodnessMask) && !(obj->m.goodness == m.goodness)) {
		m.goodness = obj->m.goodness;
		MarkUpdateAll(goodnessMask, true);
	}
	if (mask.IsBit(soulboundStateMask) && !(obj->m.soulboundState == m.soulboundState)) {
		m.soulboundState = obj->m.soulboundState;
	...
	if (mask.IsBit(OutLookColorMask) && !(obj->m.outLookColor == m.outLookColor)) {
		m.outLookColor = obj->m.outLookColor;
		MarkUpdateAll(OutLookColorMask, true);
	}
	...
	if (mask.IsBit(CultivationMask) && !(obj->m.cultivation == m.cultivation)) {
		m.cultivation = obj->m.cultivation;
		MarkUpdateAll(CultivationMask, true);
	}
	if (mask.IsBit(PracticeMask) && !(obj->m.practice == m.practice)) {
		m.practice = obj->m.practice;
		MarkUpdateAll(PracticeMask, true);
	}
}

void PartnerData_Stub::ReadAttr(CONST Buffer &buf)
{
	Parent::ReadAttr(buf);
...
void PartnerData_Stub::WriteAttr(Buffer &buf, const RPCMask &mask) CONST
{
...
RPCResult PartnerData_Stub::SendAttr(LPCPEER pPeer, RPCContext &context, const RPCMask &mask)
{
	if (pPeer == NULL) return RPC_RESULT_FAIL;

	Buffer* pBuf = SafeCreateObject(Buffer);
	Reuben::Network::RPCHeader header(RPC_PartnerData_UP_STATE);
...
#pragma optimize("", off)
RPCResult PartnerData_Stub::Process(const RPCID rpcId, LPCPEER pPeer, RPCContext &context, Buffer* pBuf)
{
	...
	case 0:
		break;
	case RPC_PartnerData_REQ_STATE:
		{
			RPCMask mask;
