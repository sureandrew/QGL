...
///////////////////////////////////////////////////////////
#pragma once
#ifndef _RPC_CHARACTERDATA_STUB_H_
#define _RPC_CHARACTERDATA_STUB_H_

#include "Common/RPCFunc.h"
#include "RPCEnum/CharacterData_enum.h"

class CharacterData_Stub : public NetObject
{
...
public:
	...
	void Clone(CharacterData_Stub* obj, const RPCMask &mask);
	friend void CharacterData_Stub::Clone(CharacterData_Stub* obj, const RPCMask &mask);
...
public:
	INLINE CharacterData_Stub()
	{ _fields _m = {}; m = _m; }

};

#endif //_RPC_CHARACTERDATA_STUB_H_
